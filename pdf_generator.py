...
def create_roast_report(name, verdict, score, roast_content, santa_comment, pil_images, template_path=None):
    ...
    try:
        ...
        # Vertical Shift: Original 90 + 0.3 inches (22pts) = 112 points
        shift_down = 112
        ...
        # --- 5. Santa's Commentary (Formatted like Verdict) ---
        c.setFont("Helvetica-Bold", 12)
        c.drawString(left_margin, current_y, f"Santa Says: \"{santa_comment}\"")
        current_y -= 25
